...
export function RepoTool({ state, input, output, elapsedTime }: RepoToolProps) {
  const libName = input?.libName;
          ...
          <div className="not-prose max-w-prose">
            <div className="flex items-center gap-2 text-muted-foreground text-sm">
              ...
              <span className="flex-1">
                Searching repository... {elapsedTime > 0 && `${elapsedTime}s`}
              </span>
            </div>
          </div>
        </motion.div>
